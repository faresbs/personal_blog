...
![Responsive image](_posts/images_2017-01-02/logistic_regression_model.png)
...
![Responsive image](_posts/images_2017-01-02/sigmoid_function.png)
...
![Responsive image](_posts/images_2017-01-02/Learning_curve (learning_rate = 0.1).png)

![Responsive image](_posts/images_2017-01-02/Learning_curve (learning_rate = 0.01).png)

![Responsive image](_posts/images_2017-01-02/Learning_curve (learning_rate = 0.001).png)
