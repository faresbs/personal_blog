...
![Responsive image](logistic_regression_model.png)
...
![Responsive image](sigmoid_function.png)
...
![Responsive image](Learning_curve (learning_rate = 0.1).png)

![Responsive image](Learning_curve (learning_rate = 0.01).png)

![Responsive image](Learning_curve (learning_rate = 0.001).png)
...
](mailto:farris.benslimane@gmail.com "E-mail")[](https://github.com/faresbs "Github")[](https://www.facebook.com/fares.benslimane "Facebook")
